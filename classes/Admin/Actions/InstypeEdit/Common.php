...
class Admin_Actions_InstypeEdit_Common extends Admin_Actions_Abstract {
	...
	public function process() {
		...
		switch ($this->objectForm->getFormState()) {
			...
			case Admin_Core::getActionName():
				...
				Admin_Core::sendLocation('global/instypes?instype_id='.$this->objectModel->getId(),'&id='.$_GET['id']);
			break;
		}
